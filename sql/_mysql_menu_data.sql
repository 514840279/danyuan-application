...
insert  into `sys_menu_info`(`uuid`,`system_id`,`parents_id`,`name`,`icon`,`sort`,`uri`,`discription`,`updata_user`,`updata_time`,`create_user`,`create_time`,`delete_flag`) values ('4c8816bd-6447-11e7-a272-0025d3a93601','99c74ada3a1411e6bdcb10bf48e1d36a','0','爬虫管理','fa fa-cloud-download',1,'pages/crwaler/index.html','爬虫管理','system','2017-07-09 06:54:00','system',NULL,0);
insert  into `sys_menu_info`(`uuid`,`system_id`,`parents_id`,`name`,`icon`,`sort`,`uri`,`discription`,`updata_user`,`updata_time`,`create_user`,`create_time`,`delete_flag`) values ('4c881b0d-6447-11e7-a272-0025d3a93601','99c74ada3a1411e6bdcb10bf48e1d36a','4c8816bd-6447-11e7-a272-0025d3a93601','规则管理','fa fa-cogs',1,'pages/crawler/ruler.html','规则管理',NULL,NULL,'system',NULL,0);
...
insert  into `sys_menu_info`(`uuid`,`system_id`,`parents_id`,`name`,`icon`,`sort`,`uri`,`discription`,`updata_user`,`updata_time`,`create_user`,`create_time`,`delete_flag`) values ('4c881dfb-6447-11e7-a272-0025d3a93601','99c74ada3a1411e6bdcb10bf48e1d36a','4c8816bd-6447-11e7-a272-0025d3a93601','结果配置','fa fa-key',2,'pages/crawler/ruler.html','结果配置','system','2017-07-09 08:35:00','system',NULL,0);
...
insert  into `sys_menu_info`(`uuid`,`system_id`,`parents_id`,`name`,`icon`,`sort`,`uri`,`discription`,`updata_user`,`updata_time`,`create_user`,`create_time`,`delete_flag`) values ('A3621F23A4BC0580D08EEF948C0FD30B',NULL,'0','用户管理','fa  fa-desktop',4,'','用户管理','system','2017-07-09 13:59:59','system',NULL,0);
