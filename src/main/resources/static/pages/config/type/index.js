...
//			$("#dbm_type_add_typeIcon").val(data[0].typeIcon);
			...
			$("#dbm_type_add_discription").val(data[0].typeClass);
...
//			typeIcon:$("#dbm_type_add_typeIcon").val(),
			...
			typeClass:$("#dbm_type_add_discription").val(),
...
//			{title : 'id',field : 'uuid',align : 'center',sortable : true,valign : 'middle',switchable:false,visible:false},
			{title : '类型名称',field : 'typeName',sortable : true,align : 'left',valign : 'middle'},
			{title : '类型描述',field : 'typeClass',align : 'left',sortable : true,valign : 'middle'},
			{title : '类型排序',field : 'typeOrder',align : 'right',sortable : true,valign : 'middle'},
			{title : '更新时间',field : 'updateTime',align : 'left',sortable : true,valign : 'middle',formatter:dateTimeFormatter},
			{title : '更新人',field : 'updateUser',sortable : true,align : 'left',valign : 'middle'},
