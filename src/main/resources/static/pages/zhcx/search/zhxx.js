$(function() {
	tableName = tableDesc ==null?tableName:tableDesc;
	$("#context_title").text(tableName+"详细信息");
	...
	for (var int = 0; int < paramString.length; int++) {
	    if(paramString[int].pageView){
	    	...
	    	var colsDesc =paramString[int].colsDesc ==null?colsName:paramString[int].colsDesc;
