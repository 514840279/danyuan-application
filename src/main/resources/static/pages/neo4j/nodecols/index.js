$(function() {
	$('#addnew_config_table').click(function() {
		...
		if(data.length == 0){
			...
			callback : function(result) {
					if (result) {
						var url = "/sysChartNodeCols/savev";
	...
	$('#deleteold_config_table').click(function() {
		...
		if(data.length == 0){
			...
			callback : function(result) {
					if (result) {
						var url = "/sysChartNodeCols/delete";
						var param={list:data};
						ajaxPost(url, param, addSysTableInfoSuccess, 5000, findError);
					}
				}
...
//		search : true, // 显示搜索框
		...
		queryParams: function queryParams(params) {  
		    var param = {  
                 ...
                 info:{
                	 uuid:search_config_table_typeUuid
                 }
             }; 
             return param;
		},
...
//		search : true, // 显示搜索框
		...
		queryParams: function queryParams(params) {  
		    var param = {  
                 ...
                 pageSize: params.pageSize,
                 info:{
                	 nodeUuid:search_config_table_typeUuid
                 }
             }; 
             return param;
		},
