...
/**
 * @文件名 SysUserWorkExpreienceDao.java
 * @包名 org.danyuan.application.resume.user.dao
 * @描述 dao层
 ...
 */
@Repository
public interface SysUserWorkExpreienceDao extends BaseDao<SysUserWorkExpreience> {
