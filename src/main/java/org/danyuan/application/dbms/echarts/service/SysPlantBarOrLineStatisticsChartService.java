...
public class SysPlantBarOrLineStatisticsChartService {
	 ...
	 * @throws
	 */
	public void buildBarOrLineSum(Map<String, Object> map, SysDbmsChartDimension info, StringBuilder sbWhere, String type1, String type2, String type3) {
		if (type3 != null) {
			buildBarOrLineType3Sum(sbWhere, type1, type2, type3, info, map);
		} else if (type2 != null) {
			buildBarOrLineType2Sum(sbWhere, type1, type2, info, map);
		} else {
			buildBarOrLineType1Sum(sbWhere, type1, info, map);
		}
	}
	 ...
	 * @throws
	 */
	private void buildBarOrLineType3Sum(StringBuilder sbWhere, String type1, String type2, String type3, SysDbmsChartDimension info, Map<String, Object> map) {
		StringBuilder sql = new StringBuilder();
		Map<String, Object> param = new HashMap<>();
		List<Map<String, Object>> series_data = new ArrayList<>();
	 ...
	 * @throws
	 */
	private void buildBarOrLineType2Sum(StringBuilder sbWhere, String type1, String type2, SysDbmsChartDimension info, Map<String, Object> map) {
		StringBuilder sql = new StringBuilder();
		Map<String, Object> param = new HashMap<>();
		List<Map<String, Object>> series_data = new ArrayList<>();
	 ...
	 * @throws
	 */
	private void buildBarOrLineType1Sum(StringBuilder sbWhere, String type1, SysDbmsChartDimension info, Map<String, Object> map) {
		StringBuilder sql = new StringBuilder();
		Map<String, Object> param = new HashMap<>();
