...
public class SysDbmsTabsMergeInfo extends BaseEntity implements Serializable {
	...
	// 
	@Column(name = "cols_name_2", columnDefinition = " COMMENT ''")
	private  String 	colsName2;

	// 
	@Column(name = "table_uuid_2", columnDefinition = " COMMENT ''")
	private  String 	tableUuid2;

	// 
	@Column(name = "cols_desc_2", columnDefinition = " COMMENT ''")
	private  String 	colsDesc2;

	// 
	@Column(name = "cols_name_1", columnDefinition = " COMMENT ''")
	private  String 	colsName1;

	// 
	@Column(name = "cols_desc_1", columnDefinition = " COMMENT ''")
	private  String 	colsDesc1;

	// 
	@Column(name = "table_uuid_1", columnDefinition = " COMMENT ''")
